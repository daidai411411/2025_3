...
const Tools = () => {
  ...
  if (tool_level) {
    // tool_level が null でない場合に cost を計算
  ...
  return (
    <div className="testDiv Case2">
      ...
      <div className="tool_level">
        ...
        <br />
        Lv.{tool_level}
        <img src={currentTool.img_path} alt={currentTool.name} />
        {/* ツール画像を表示 */}
      </div>
      <button
        className="button2"
        ...
        disabled={
          money === null ||
          money < cost ||
          tool_level >= 50 * initialTools.length
        } // 上限レベルに達した場合もdisabledにする
      >
